...
- Domain value objects and developer-facing fluent APIs must fail fast on violated invariants. Use `InvalidArgumentException` for invalid caller arguments and named domain exceptions for failures callers need to distinguish.
